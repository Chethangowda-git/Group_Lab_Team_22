...
public class ProfileWorkAreaMainFrame extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        // Route to appropriate work area based on role
        if (profile instanceof EmployeeProfile) {
            // Admin
            EmployeeProfile adminProfile = (EmployeeProfile) profile;
            AdminRoleWorkAreaJPanel adminworkarea = new AdminRoleWorkAreaJPanel(business, adminProfile, CardSequencePanel);
            ...
            StudentWorkAreaJPanel studentworkarea = new StudentWorkAreaJPanel(business, spp, CardSequencePanel);
            CardSequencePanel.removeAll();
            ...
            FacultyWorkAreaJPanel facultyworkarea = new FacultyWorkAreaJPanel(business, fpp, CardSequencePanel);
            CardSequencePanel.removeAll();
            ...
            RegistrarWorkAreaJPanel registrarworkarea = new RegistrarWorkAreaJPanel(business, rpp, CardSequencePanel);
            CardSequencePanel.removeAll();
