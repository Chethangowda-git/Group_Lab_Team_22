...
public class EditStudentPanel extends javax.swing.JPanel {
    ...
    public EditStudentPanel(Business b, StudentProfile sp, JPanel clp) {
        business = b;
        student = sp;
    ...
    private void initComponents() {
        lblTitle = new JLabel("Edit Student Record");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {
        if (txtFirstName.getText().trim().isEmpty() || 
            ...
            lblMessage.setText("⚠️ Please fill all required fields!");
