...
/**
 * Manage Course Details Panel Faculty can view enrolled students and assign
 * grades
 */
public class ManageCourseDetailsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnGradeStudent);
        btnGradeStudent.setBounds(450, 450, 150, 35);

        add(btnViewRankings);
        btnViewRankings.setBounds(620, 450, 150, 35);

        add(btnRefresh);
        btnRefresh.setBounds(320, 450, 100, 35);
...
ArrayList<StudentProfile> allStudents = sd.getStudentList();
    ...
    for (Seat seat : seats) {
        if (seat.isOccupied()) {
            ...
            // Find which student has this course load
            String studentName = "Unknown Student";
            String studentId = "Unknown";
            
            if (courseLoad != null) {
                // Search through all students to find who owns this course load
                for (StudentProfile sp : allStudents) {
                    ...
                    if (studentAssignments != null && studentAssignments.contains(sa)) {
...
//                    selectedSeatAssignment = seat.seatassignment;
